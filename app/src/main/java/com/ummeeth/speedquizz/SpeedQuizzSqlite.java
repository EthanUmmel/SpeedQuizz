...
public class SpeedQuizzSqlite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sqlCreateDataTable = "CREATE TABLE Question (idQuizz INTEGER PRIMARY KEY,question TEXT,reponse INTEGER)";
        ...
        sqLiteDatabase.execSQL("INSERT INTO Question VALUES (null,\"🎵Le cheval, c'est vraiment trop génial:]🎵\", 0)");
        ...
        sqLiteDatabase.execSQL("INSERT INTO Question VALUES (null,\"N'appuis pas !! Sinon...    (°ー°〃)\", 1)");
